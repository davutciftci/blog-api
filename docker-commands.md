...
docker run --name blog-postgres `  -e POSTGRES_USER=postgres`
-e POSTGRES_PASSWORD=postgres `  -e POSTGRES_DB=blog_dev`
-p 5432:5432 `
...
docker run --name blog-api-container `  --network blog-network`
-p 3000:3000 `  -e DATABASE_URL="postgresql://postgres:postgres@blog-postgres:5432/blog_dev"`
-e JWT_SECRET="secret" `
-d blog-api
